...
;VRAM Absolute Data
	...
	.DEF	TONBOW_DASH_LENGTH_TIMER_VALUE			$10		
...
@DeadTonbow:
; No longer point to entity.0, or whatever Tonbow is set to for the player pointer
	ld a, lobyte(entity.dummy)
	ld ($FF00 + playerOneEntityPointerLO), a
	ld a, hibyte(entity.dummy)
	ld ($FF00 + playerOneEntityPointerHI), a

;Reset the arcadeFlag to be dead
	;ld a, (arcadeFlags)
	;res 0, a
	;ld (arcadeFlags), a
