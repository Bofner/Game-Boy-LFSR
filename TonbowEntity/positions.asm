...
@@NotDashing:
;If not, move Attack Hitbox offscreen
	ld de, tonbowStructure.atkHitbox.y1 - tonbowStructure.eventID
	add hl, de								;HL = tonbow.atkHitBox.width
	ld (hl), Y_OFFSCREEN
	ld de, tonbowStructure.dmgHitbox - tonbowStructure.atkHitbox.y1
	add hl, de
	ret
